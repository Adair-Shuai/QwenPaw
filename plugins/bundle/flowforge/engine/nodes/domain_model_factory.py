...
mirrors :mod:`.tool_factory` and
:mod:`.agent_node_factory`: each registered domain
...
node via :func:`.domain_model_nodes.build_domain_model_node`.
...
def register_domain_model_nodes(
    ...
    builder = None
    try:
        from .domain_model_nodes import build_domain_model_node
