...
LangString qwenpawOptionalPageDescription ${LANG_ENGLISH} "Selected components are downloaded from a China mirror after the core app is installed. Internet access is required."
...
LangString qwenpawOptionalInstalling ${LANG_ENGLISH} "Downloading and installing:"
LangString qwenpawOptionalInstalled ${LANG_ENGLISH} "Optional component installed:"
LangString qwenpawOptionalFailed ${LANG_ENGLISH} "Optional component failed; rerun the installer later:"
