...
LangString qwenpawOptionalPageDescription ${LANG_SIMPCHINESE} "所选组件将在主程序安装完成后从国内镜像下载，需要网络连接。"
...
LangString qwenpawOptionalInstalling ${LANG_SIMPCHINESE} "正在下载并安装："
LangString qwenpawOptionalInstalled ${LANG_SIMPCHINESE} "可选组件安装完成："
LangString qwenpawOptionalFailed ${LANG_SIMPCHINESE} "可选组件安装失败，可稍后重新运行安装程序："
