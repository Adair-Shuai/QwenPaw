            ...
            <div className={styles.catalogRow} key={entry.id}>
                ...
                <div className={styles.catalogNameRow}>
                  ...
                  {entry.qwenpaw_compat_labels &&
                    entry.qwenpaw_compat_labels.length > 0 && (
                      ...
                      >
                        {`UGSci ${entry.qwenpaw_compat_labels.join(", ")}`}
                      </Tag>
                    )}
                </div>
                {entry.locales && (
              ...
              <div className={styles.catalogActions}>
                ...
                <Tooltip
                  title={
                    !isCompatible(entry)
                      ? `This plugin is labeled for UGSci ${
                          entry.qwenpaw_compat_labels?.join(", ") ?? "unknown"
                        }; compatibility with UGSci ${
                      ...
                      if (!isCompatible(entry)) {
                        Modal.confirm({
                          ...
                          content: t("pluginManager.compatWarningContent", {
                            defaultValue:
                              "This plugin is labeled for UGSci {{labels}}. Your UGSci version is {{version}}. Installing it may cause errors. Are you sure you want to continue?",
                            labels:
