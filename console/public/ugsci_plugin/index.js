  ...
  return t.createElement(
    ...
    t.createElement(
      ...
      ...(f
        ? i
            .map((c, p) => {
              const P = e.members.find((v) => v.name === c.agentName);
              return [
...
function Jt({ open: e, onClose: t, agents: a, editingTeam: n, onSaved: l }) {
  const r = h().React,
    { useState: s, useEffect: i, useCallback: f } = r,
    {
      Modal: c,
      Input: p,
      Button: P,
    ...
    } = h().antd,
    {
      ...
      DeleteOutlined: R,
      SaveOutlined: _,
      ArrowRightOutlined: B,
    } = h().antdIcons || {},
    { Text: N, Paragraph: g } = H,
    [z, I] = s(""),
    [q, T] = s("🤝"),
    [w, d] = s(""),
    [L, j] = s("pipeline"),
...
任务描述：{任务描述}`),
  ...
  const C = f(() => {
      if (L === "roundtable") {
        ...
        const D = new Map(o.map((ne) => [ne.agentName, ne])),
          $ = U.map(
            (ne) =>
              D.get(ne) || {
                agentName: ne,
      ...
      try {
        const D = U.map((Ee) => {
          ...
          return {
            name: Ee,
            role:
              ((Te = ie == null ? void 0 : ie.description) == null
                ? void 0
                : Te.slice(0, 30)) || "团队成员",
            emoji: "👤",
          };
        ...
        const ne = {
          ...
          F = Ke(),
          he = F.findIndex((Ee) => Ee.id === ne.id);
        he >= 0 ? (F[he] = ne) : F.push(ne),
          St(F),
          O.success(n ? "团队已更新" : "团队已创建"),
          l(),
          t();
      } catch (D) {
    ...
    we = a.filter((D) => !U.includes(D.name));
    ...
    r.createElement(
      ...
      r.createElement(
        ...
        r.createElement(v, {
          ...
          optionRender: (D) =>
            r.createElement("span", { style: { fontSize: 18 } }, D.value),
        }),
        r.createElement(p, {
                    ...
                    r.createElement(
                      ...
                      r.createElement(
                        ...
                        r.createElement(p, {
                          ...
                          value: D.instruction,
                          onChange: (ne) =>
                            se($, "instruction", ne.target.value),
                          size: "small",
                        }),
                      ),
                    ),
...
function mt({ team: e, agents: t, onLaunch: a, onEdit: n, onDelete: l }) {
  var w;
  const r = h().React,
    { useState: s } = r,
    { Card: i, Tag: f, Typography: c, Button: p, Tooltip: P } = h().antd,
    {
      TeamOutlined: v,
      RocketOutlined: E,
      UserOutlined: H,
    ...
    N = B[e.mode] || B.coordinator,
    g = e.members.map((d) => {
      const L = Ve(t, d.name);
      return { ...d, found: !!L, agentId: L };
    }),
    z = g.filter((d) => d.found).length,
    I = z === e.members.length,
    q = e.coordinatorName || ((w = e.members[0]) == null ? void 0 : w.name),
    T = q ? Ve(t, q) : null;
  return r.createElement(
    i,
    {
    ...
    r.createElement(
      ...
      r.createElement(
        ...
        r.createElement(
          "div",
          { style: { display: "flex", alignItems: "center", gap: 6 } },
          r.createElement(S, { strong: !0, style: { fontSize: 14 } }, e.name),
          e.custom
            ? r.createElement(
                f,
...
function Xt({ agents: e, onLaunch: t }) {
  const a = h().React,
    { useMemo: n, useState: l, useCallback: r, useEffect: s } = a,
    {
      Row: i,
      Col: f,
      Input: c,
  ...
  const w = r(() => {
    ...
    M = n(() => {
      ...
      return Z.filter(
        (ae) =>
          ae.name.toLowerCase().includes(o) ||
          ae.description.toLowerCase().includes(o) ||
          ae.category.toLowerCase().includes(o),
      );
    }, [Z, _]),
    u = M.filter((o) => o.custom),
    ee = M.filter((o) => !o.custom);
...
function Qe({ title: e, subtitle: t, extra: a }) {
  const n = h().React,
    { Space: l } = h().antd;
...
function pt({ items: e, max: t = 5, color: a = "blue", emptyText: n = "无" }) {
  const l = h().React,
    { Tag: r } = h().antd;
  return !e || e.length === 0
...
function Tt({
  ...
  const s = h().React,
    { useState: i, useEffect: f, useMemo: c } = s,
    {
      Modal: p,
      Button: P,
      Empty: v,
    ...
    { CheckOutlined: W, SearchOutlined: S } = h().antdIcons || {},
    { Text: V } = O,
    [R, _] = i([]),
    [B, N] = i("");
  f(() => {
  ...
  const g = c(() => {
      ...
      return a.filter((w) => {
        ...
        return (
          ...
          ((d = w.description) == null
            ? void 0
            : d.toLowerCase().includes(T)) ||
          ((L = w.tags) == null
            ? void 0
            : L.some((j) => j.toLowerCase().includes(T)))
        );
      });
    }, [a, B]),
    z = g.filter((T) => !n.includes(T.name)),
    I = (T) => {
      _((w) => (w.includes(T) ? w.filter((d) => d !== T) : [...w, T]));
    },
    q = async () => {
...
function fn({ agentId: e }) {
  const t = h().React,
    ...
    { PlayCircleOutlined: E, SaveOutlined: H } = h().antdIcons || {},
    { Text: x } = P,
    [A, O] = a(!0),
    [W, S] = a(!1),
    [V, R] = a(!1),
    ...
    o = l(async () => {
      ...
      try {
        ...
        B(y.enabled ?? !1),
          ...
          I(se.unit),
          T(y.target ?? "main"),
          d(y.timeoutSeconds ?? 300),
          j(!!y.activeHours),
          M(((C = y.activeHours) == null ? void 0 : C.start) ?? "08:00"),
          ee(((re = y.activeHours) == null ? void 0 : re.end) ?? "22:00");
      } catch (y) {
  ...
  const Q = (C, re, y) =>
      t.createElement(
        ...
        re,
        y ? t.createElement(x, { type: "secondary", style: _t }, y) : null,
      ),
    J = (C, re, y, se) =>
      t.createElement(
        "div",
...
function En({ agentId: e, onRefresh: t }) {
  const a = h().React,
  ...
  const w = async () => {
    ...
    d = async (M) => {
      ...
      u > 0
        ? (E.success(`成功添加 ${u} 个技能${ee > 0 ? `，${ee} 个失败` : ""}`),
          T(),
          t())
        : ee > 0 && E.error("添加技能失败"),
        N(!1);
    ...
    L = async (M, u) => {
      try {
        u ? await qt(e, M.name) : await nn(e, M.name),
          E.success(u ? "已启用" : "已停用"),
          T(),
          t();
      } catch (ee) {
...
function hn({ agentId: e, onRefresh: t, isActive: a }) {
  const n = h().React,
    { useState: l, useEffect: r, useCallback: s } = n,
    {
      List: i,
      Tag: f,
      Button: c,
    ...
    M = async () => {
      ...
      try {
        ...
        u instanceof SyntaxError
          ? x.error("JSON 格式错误：" + u.message)
          : x.error(u.message || "创建 MCP 失败");
      } finally {
        d(!1);
      }
    };
...
function vn({ agentId: e }) {
  const t = h().React,
    ...
    Le = l(async () => {
      ...
      try {
        ...
        (B.current = ue),
          g(ue.shell_command_timeout ?? 60),
          I(ue.shell_command_executable ?? "");
        const Xe = ue.auto_title_config ?? { enabled: !0, timeout_seconds: 30 };
        T(Xe.enabled ?? !0), d(Xe.timeout_seconds ?? 30), j(Ze), M(et);
        const He = ue.loop ?? {};
        ee(((k = He.iteration) == null ? void 0 : k.enabled) ?? !0),
          ae(
            ((xe = He.iteration) == null ? void 0 : xe.max_iterations) ??
              ue.max_iters ??
              100,
          ),
          Q(((Ce = He.doom_loop) == null ? void 0 : Ce.enabled) ?? !0),
          K(((ze = He.doom_loop) == null ? void 0 : ze.window_size) ?? 3),
          re(
            ((ke = He.doom_loop) == null ? void 0 : ke.similarity_threshold) ??
              1,
          ),
          se(ue.llm_retry_enabled ?? !0),
          Se(ue.llm_max_retries ?? 3),
          D(ue.llm_backoff_base ?? 2),
          ne(ue.llm_backoff_cap ?? 60),
          he(ue.llm_max_concurrent ?? 1),
          ie(ue.llm_max_qpm ?? 0),
          _e(ue.llm_rate_limit_pause ?? 1),
          b(ue.llm_rate_limit_jitter ?? 0),
          me(ue.llm_acquire_timeout ?? 30),
          fe(ue.history_max_length ?? 50),
          Ae(ue.context_manager_backend ?? "light"),
          Ue(
            (($e = ue.light_context_config) == null ? void 0 : $e.strategy) ??
              "scroll",
          ),
          Be(ue.memory_manager_backend ?? "remelight"),
          Fe(ue.approval_level ?? "AUTO");
      } catch (ue) {
        ...
        const ze = {
          ...
          loop: {
            ...
            doom_loop: {
              ...
              stages:
                ((Ce = (xe = k.loop) == null ? void 0 : xe.doom_loop) == null
                  ? void 0
                  : Ce.stages) ?? [],
            },
          },
  ...
  const G = (k, xe, Ce) =>
      t.createElement(
        ...
        xe,
        Ce ? t.createElement(W, { type: "secondary", style: _t }, Ce) : null,
      ),
    ce = (k, xe, Ce, ze) =>
      t.createElement(
        "div",
  ...
  return t.createElement(
    ...
    { style: { paddingBottom: 8 } },
    // ── Section: 基础设置 ──
    t.createElement("div", { style: De }, "基础设置"),
    ce(
      "Shell 命令超时 (秒)",
      t.createElement(i, {
        min: 1,
    ...
    ce(
      ...
      t.createElement(c, {
        ...
        filterOption: (k, xe) => {
          var Ce;
          return (
            ((Ce = xe == null ? void 0 : xe.label) == null
              ? void 0
              : Ce.toString()) || ""
          )
            .toLowerCase()
...
function bn({ expert: e, open: t, onClose: a, onRefresh: n }) {
  const l = h().React,
    { useState: r, useEffect: s, useCallback: i } = l,
    { Modal: f, Tabs: c, Spin: p, Typography: P } = h().antd,
...
function Sn({ expert: e, onClick: t, onSummon: a, onConfigure: n }) {
  const l = h().React,
    {
      Card: r,
      Tag: s,
    ...
    { Text: v } = f,
    { ThunderboltOutlined: E, SettingOutlined: H } = h().antdIcons || {},
    { agent: x, skills: A, mcps: O, loading: W } = e,
    S = x.enabled,
    V = A.filter((B) => B.enabled !== !1).map((B) => B.name),
    R = O.map((B) => B.name || B.key),
    _ = x.active_model
      ? `${x.active_model.provider_id}/${x.active_model.model}`
      : null;
  return l.createElement(
    r,
    {
    ...
    l.createElement(
      ...
      l.createElement(
        ...
        l.createElement(
          "div",
          null,
          l.createElement(v, { strong: !0, style: { fontSize: 15 } }, x.name),
          l.createElement(
            "div",
            {
              style: {
...
function wn({ expert: e, open: t, onClose: a, onRefresh: n }) {
  const l = h().React,
    {
      Drawer: r,
      Descriptions: s,
    ...
    [q, T] = l.useState(!1);
  if (!e) return null;
  const { agent: w, config: d, skills: L, mcps: j, loading: Z } = e,
    M = L.filter((y) => y.enabled !== !1),
    u = (y) => {
    ...
    ee = l.createElement(
      ...
      l.createElement(
        ...
        l.createElement(
          ...
          { label: "使用模型" },
          w.active_model
            ? `${w.active_model.provider_id} / ${w.active_model.model}`
            : "使用全局默认模型",
        ),
        d != null && d.workspace_dir
          ? l.createElement(
              s.Item,
              { label: "工作区路径" },
              l.createElement(
          ...
          : null,
        d != null && d.approval_level
          ? l.createElement(s.Item, { label: "审批级别" }, d.approval_level)
          : null,
      ),
      // System prompt files
      d != null && d.system_prompt_files && d.system_prompt_files.length > 0
        ? l.createElement(
            "div",
            { style: { marginTop: 16 } },
            l.createElement(
            ...
            l.createElement(
              c,
              { wrap: !0 },
              ...d.system_prompt_files.map((y, se) =>
                l.createElement(
                  i,
                  {
                    key: se,
    ...
    ae = async (y) => {
      ...
      se > 0
        ? (A.success(`成功添加 ${se} 个技能${oe > 0 ? `，${oe} 个失败` : ""}`),
          n())
        : oe > 0 && A.error("添加技能失败"),
        g(!1);
    },
    ...
    J = Z
      ...
      : l.createElement(
          ...
          l.createElement(
            ...
            l.createElement(O, { strong: !0 }, `已启用技能 (${M.length})`),
            l.createElement(
              p,
              {
                type: "primary",
    ...
    K = Z
      ...
      : l.createElement(
          ...
          l.createElement(
            ...
            l.createElement(O, { strong: !0 }, `MCP 客户端 (${j.length})`),
            l.createElement(
              p,
              {
                type: "primary",
                ...
                icon: B ? l.createElement(B) : void 0,
                onClick: () => {
                  window.history.pushState({}, "", `/agents/${w.id}/mcp`),
                    window.dispatchEvent(new PopStateEvent("popstate"));
                },
              },
              "配置 MCP",
                  ...
                  l.createElement(
                    ...
                    l.createElement(
                      ...
                      l.createElement(
                        ...
                        l.createElement(O, { strong: !0 }, y.name || y.key),
                        l.createElement(
                          i,
                          {
...
function xn({ open: e, onClose: t, onCreated: a }) {
  const n = h().React,
    { useState: l } = n,
    {
      Modal: r,
...
`,
    ...
    B = nt.filter((g) => {
      ...
      return (
        g.name.toLowerCase().includes(z) ||
        g.description.toLowerCase().includes(z) ||
        g.category.toLowerCase().includes(z)
      );
    }),
    N = async (g) => {
      O(!0);
      try {
        ...
        (I.approval_level = g.approvalLevel),
          await te(`/agents/${encodeURIComponent(z.id)}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(I),
          }),
          v.success(`专家「${g.name}」创建成功`),
          t(),
          a();
      } catch (z) {
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  n.createElement("span", { style: { fontSize: 28 } }, g.emoji),
                  n.createElement(
                    "div",
                    { style: { flex: 1 } },
                    n.createElement(
...
function Cn({ open: e, onCancel: t, onCreate: a }) {
  const n = h().React,
    { useState: l } = n,
    { Modal: r, Input: s, message: i } = h().antd,
    [f, c] = l(""),
    [p, P] = l("");
  return n.createElement(
    r,
...
function Pt({ agentId: e, systemPromptFiles: t, onRefresh: a }) {
  const n = h().React,
    { useState: l, useEffect: r, useCallback: s } = n,
    {
      List: i,
  ...
  const ae = async (K, C) => {
    ...
    U = async (K) => {
      try {
        const C = await te(`/workspace/files/${encodeURIComponent(K)}`, {
          headers: { "X-Agent-Id": e },
        });
        d(K), j(C.content || ""), T(!0);
      } catch (C) {
    ...
    : n.createElement(
        ...
        n.createElement(
          ...
          n.createElement(
            ...
            O
              ...
              : null,
            n.createElement(R, { strong: !0 }, `记忆文件 (${_.length})`),
            n.createElement(
              R,
              { type: "secondary", style: { fontSize: 12 } },
              `· 已挂载 ${z.length} 个到专家记忆`,
        ...
        _.length === 0
          ...
          : n.createElement(i, {
              dataSource: _,
              renderItem: (K) => {
                const C = z.includes(K.filename),
                  re = ut.includes(K.filename);
                return n.createElement(
                  i.Item,
                  {
                    actions: [
                  ...
                  n.createElement(i.Item.Meta, {
                    ...
                    description: n.createElement(
                      "div",
                      { style: { fontSize: 12 } },
                      `${(K.size / 1024).toFixed(1)} KB · 修改于 ${new Date(
                        K.modified_time,
                      ).toLocaleString()}`,
                    ),
                  }),
...
function kn({ skills: e, agentId: t }) {
  const a = h().React,
    ...
    { ThunderboltOutlined: p, CopyOutlined: P } = h().antdIcons || {},
    { Text: v } = s,
    E = n(() => Kt(e), [e]),
    H = (A) => {
      try {
    ...
    : a.createElement(
        ...
        a.createElement(
          ...
          p
            ...
            : null,
          a.createElement(v, { strong: !0 }, `推荐提问 (${E.length})`),
          a.createElement(
            v,
            { type: "secondary", style: { fontSize: 12 } },
            "· 从技能描述中自动提取",
...
function Tn() {
  ...
  a(() => {
    ...
    a(() => {
      if (C && J) {
        const b = _.find((le) => le.agent.id === C.agent.id);
        b && b !== C && re(b);
      }
    }, [_, C, J]);
  const Se = n(
      async (b) => {
        var fe;
        const le =
          b.coordinatorName || ((fe = b.members[0]) == null ? void 0 : fe.name);
        if (!le) {
          c.error("无法确定协调者专家");
          return;
        }
    ...
    we = n(
      async (b, le, me) => {
        ...
        try {
          const fe = Wt(b),
            be = me ? fe.replace(b.taskTemplate, me) : fe,
            Ae = h();
          Ae.setSelectedAgent && Ae.setSelectedAgent(le),
            await Ht(le, be),
            c.success(
              `团队任务已发起，协调者：${
                b.coordinatorName ||
                ((de = b.members[0]) == null ? void 0 : de.name)
              }`,
            ),
            ee(null),
            D("/chat");
    ...
    F = n(
      (b) => {
        ...
        c.success(`已召唤专家「${b.agent.name}」，正在跳转至对话...`),
          D("/chat");
      },
      [c],
    ),
    he = l(() => {
      ...
      return _.filter((le) => {
        var me;
        return (
          le.agent.name.toLowerCase().includes(b) ||
          ((me = le.agent.description) == null
            ? void 0
            : me.toLowerCase().includes(b)) ||
          le.agent.id.toLowerCase().includes(b) ||
          le.skills.some((de) => de.name.toLowerCase().includes(b))
        );
      });
    }, [_, w]),
    Ee = _.filter((b) => b.agent.enabled).length,
    ie = _.reduce(
      (b, le) => b + le.skills.filter((me) => me.enabled !== !1).length,
      0,
    ),
    Te = _.reduce((b, le) => b + le.mcps.length, 0),
    _e = [
      {
        key: "experts",
      ...
      ? e.createElement(
          E,
          {
            ...
            title: e.createElement(
              "div",
              { style: { display: "flex", alignItems: "center", gap: 8 } },
              e.createElement("span", { style: { fontSize: 20 } }, u.emoji),
              e.createElement("span", null, `发起团队任务 - ${u.name}`),
            ),
            onCancel: () => ee(null),
            onOk: () => {
              var de;
              const b =
                  u.coordinatorName ||
                  ((de = u.members[0]) == null ? void 0 : de.name),
                le = b ? Ve(y, b) : null;
              if (!le) {
                c.error("无法找到协调者专家");
                return;
          ...
          e.createElement(
            ...
            e.createElement(
              ...
              `协调者: ${
                u.coordinatorName ||
                ((X = u.members[0]) == null ? void 0 : X.name) ||
                "—"
              } · 成员: ${u.members.map((b) => b.name).join("、")}`,
            ),
          ),
        )
      : null,
...
function zn({ mcp: e, onClick: t, onToggle: a, onDelete: n, onViewTools: l }) {
  const r = h().React,
    { Card: s, Tag: i, Badge: f, Typography: c, Button: p } = h().antd,
    { Text: P } = c,
    {
      EyeOutlined: v,
    ...
    a.createElement(
      ...
      a.createElement(
        ...
        a.createElement(
          "div",
          null,
          a.createElement(s, { strong: !0, style: { fontSize: 14 } }, e.name),
          a.createElement("br"),
          a.createElement(
            s,
            { type: "secondary", style: { fontSize: 11 } },
  ...
  const Se = l(() => {
      ...
      return w.filter((b) => {
        ...
        return (
          ...
          b.vendor.toLowerCase().includes(X) ||
          b.category.toLowerCase().includes(X) ||
          ((le = b.description) == null ? void 0 : le.toLowerCase().includes(X))
        );
      });
    }, [w, Z]),
    we = w.filter((X) => X.status === "detected").length,
    D = n((X) => {
      navigator.clipboard
        .writeText(X)
        .then(() => f.success("路径已复制"))
        .catch(() => f.error("复制失败"));
    }, []),
    $ = n(() => {
      K(null),
    ...
    F = n(async () => {
      ...
      try {
        J
          ? (await Pn(J.id, C), f.success("引擎已更新"))
          : (await _n(C), f.success("引擎已添加")),
          Q(!1),
          oe();
      } catch (b) {
    ...
    o
      ? e.createElement(
          ...
          e.createElement(
            v,
            { column: 1, bordered: !0, size: "small" },
            e.createElement(v.Item, { label: "引擎名称" }, o.name),
            e.createElement(v.Item, { label: "厂商" }, o.vendor || "—"),
            e.createElement(
              v.Item,
              { label: "分类" },
            ...
            e.createElement(v.Item, { label: "版本" }, o.version || "—"),
            o.executable_path
              ? e.createElement(
                  v.Item,
                  { label: "可执行文件" },
                  ...
                  e.createElement(
                    ...
                    ...o.modules.map((X) =>
                      e.createElement(
                        ...
                        o.module_paths && o.module_paths[X]
                          ? e.createElement(
                              "code",
                              {
            ...
            o.license_server
              ...
              : null,
            e.createElement(v.Item, { label: "描述" }, o.description || "—"),
          ),
          // Invocation hint
          o.invocation_hint
            ? e.createElement(
          ...
          e.createElement(
            ...
            { style: { marginTop: 12 } },
            o.is_default
              ? e.createElement(E, { color: "blue" }, "默认引擎")
              : o.is_custom
              ? e.createElement(E, { color: "purple" }, "自定义引擎")
              : null,
          ),
        )
      : null,
...
function Rn() {
  const e = h().React,
    ...
    { Text: q } = x,
    { TextArea: T } = i,
    d = h().useSelectedAgent,
    L = d ? d() : null,
    j = (L == null ? void 0 : L.id) || "default",
    [Z, M] = t([]),
    [u, ee] = t(!0),
    [o, ae] = t(""),
    [U, Q] = t(!1),
  ...
  const Ae = n(
    ...
    Ue = n(async () => {
      ...
      try {
        ...
        for (const [Ce, ze] of k) {
          const ke = ze,
            $e = ke.url ? "streamable_http" : "stdio",
            ue = {
              name: ke.name || Ce,
        ...
        G instanceof SyntaxError
          ? c.error("JSON 格式错误：" + G.message)
          : c.error(G.message || "创建 MCP 失败");
      } finally {
        D(!1);
      }
    }, [oe, j, be]),
    We = n(
      async (G) => {
        _e(G), ie(!0), b([]), fe(""), me(!0);
        try {
          const ce = await Ut(j, G.key);
          b(ce);
        } catch (ce) {
          fe(ce.message || "无法加载工具列表（MCP 服务可能未运行）");
        } finally {
          me(!1);
        }
      },
    ...
    Be = l(() => {
      ...
      return Z.filter((ce) => {
        var k;
        return (
          ce.name.toLowerCase().includes(G) ||
          ce.key.toLowerCase().includes(G) ||
          ((k = ce.description) == null
            ? void 0
            : k.toLowerCase().includes(G)) ||
          ce.transport.toLowerCase().includes(G)
        );
      });
    }, [Z, o]),
    Ie = Z.filter((G) => G.enabled).length,
    Fe = Z.reduce((G, ce) => {
      var k;
  ...
  return e.createElement(
      ...
      ? e.createElement(
          v,
          {
            title: e.createElement(
              ...
              e.createElement("span", null, J.name || J.key),
            ),
            open: U,
            onClose: () => Q(!1),
            width: 480,
          ...
          e.createElement(
            ...
            e.createElement(
              E.Item,
              { label: "Key" },
              e.createElement("code", { style: { fontSize: 12 } }, J.key),
            ),
            e.createElement(E.Item, { label: "名称" }, J.name || "-"),
            e.createElement(E.Item, { label: "描述" }, J.description || "-"),
            e.createElement(
              E.Item,
              { label: "状态" },
              e.createElement(
            ...
            e.createElement(E.Item, { label: "传输方式" }, J.transport),
            J.url ? e.createElement(E.Item, { label: "URL" }, J.url) : null,
            J.command
              ? e.createElement(
                  E.Item,
                  { label: "命令" },
            ...
            J.args && J.args.length > 0
              ? e.createElement(E.Item, { label: "参数" }, J.args.join(" "))
              : null,
          ),
          J.tools && J.tools.length > 0
            ? e.createElement(
                "div",
                { style: { marginTop: 16 } },
                e.createElement(
                    ...
                    e.createElement(
                      ...
                      e.createElement(
                        ...
                        _
                          ...
                          : null,
                        e.createElement(q, { style: { fontSize: 12 } }, G),
                      ),
                    ),
                }),
              )
    ...
    e.createElement(
      ...
      e.createElement(
        ...
        null,
        `确定要删除 MCP 客户端「${
          (F == null ? void 0 : F.name) || (F == null ? void 0 : F.key)
        }」吗？此操作不可撤销。`,
      ),
    ),
    ...
    e.createElement(
      W,
      {
        ...
        footer: e.createElement(f, { onClick: () => ie(!1) }, "关闭"),
        width: 640,
      },
      le
        ? e.createElement(
...
function Ln({ agentId: e, agentName: t, onNavigate: a }) {
  const n = h().React,
    { useState: l, useEffect: r, useCallback: s } = n,
    {
      Spin: i,
    ...
    { Text: q, Paragraph: T } = A,
    [w, d] = l([]),
    [L, j] = l(!0),
    [Z, M] = l(!1),
    [u, ee] = l(null),
    [o, ae] = l(!1),
    [U, Q] = l(/* @__PURE__ */ new Set()),
    [J, K] = l(!1),
    C = s(async () => {
      if (e) {
        j(!0);
  ...
  const re = ($) => {
    ...
    y = () => Q(/* @__PURE__ */ new Set()),
    se = () => Q(new Set(w.map(($) => $.name))),
    oe = () => {
      o ? (y(), ae(!1)) : ae(!0);
    },
    Se = async () => {
      ...
      if ($.length !== 0) {
        K(!0);
        try {
          const { results: ne } = await Yt(e, $),
            F = Object.entries(ne).filter(([, Ee]) => Ee.success === !1),
            he = $.length - F.length;
          F.length > 0
            ? S.warning(`批量启用完成：成功 ${he} 个，失败 ${F.length} 个`)
            : S.success(`成功启用 ${$.length} 个技能`),
            y(),
            await C();
        } catch (ne) {
    ...
    we = async () => {
      ...
      if ($.length !== 0) {
        K(!0);
        try {
          const { results: ne } = await Qt(e, $),
            F = Object.entries(ne).filter(([, Ee]) => Ee.success === !1),
            he = $.length - F.length;
          F.length > 0
            ? S.warning(`批量停用完成：成功 ${he} 个，失败 ${F.length} 个`)
            : S.success(`成功停用 ${$.length} 个技能`),
            y(),
            await C();
        } catch (ne) {
      ...
      $.length !== 0 &&
        x.confirm({
          ...
          onOk: async () => {
            K(!0);
            try {
              const { results: ne } = await Zt(e, $),
                F = Object.entries(ne).filter(([, Ee]) => Ee.success === !1),
                he = $.length - F.length;
              F.length > 0
                ? S.warning(`批量删除完成：成功 ${he} 个，失败 ${F.length} 个`)
                : S.success(`成功删除 ${$.length} 个技能`),
                y(),
                await C();
            } catch (ne) {
      ...
      n.createElement(
        ...
        o
          ? n.createElement(
              n.Fragment,
              null,
              n.createElement(c, { size: "small", onClick: se }, "全选"),
              n.createElement(
                c,
                {
                  size: "small",
    ...
    u
      ? n.createElement(
          ...
          n.createElement(
            W,
            { column: 1, bordered: !0, size: "small" },
            n.createElement(W.Item, { label: "技能名称" }, u.name),
            n.createElement(W.Item, { label: "描述" }, u.description || "-"),
            u.version_text
              ? n.createElement(W.Item, { label: "版本" }, u.version_text)
              : null,
            n.createElement(W.Item, { label: "来源" }, u.source || "-"),
            n.createElement(
              W.Item,
              { label: "状态" },
              u.enabled === !1 ? "已禁用" : "已启用",
            ...
            u.installed_from
              ? n.createElement(W.Item, { label: "安装来源" }, u.installed_from)
              : null,
          ),
          // Tags
          u.tags && u.tags.length > 0
            ? n.createElement(
                ...
                n.createElement(
                  ...
                  { style: { display: "flex", flexWrap: "wrap", gap: 4 } },
                  ...u.tags.map(($, ne) =>
                    n.createElement(E, { key: ne, color: "blue" }, $),
                  ),
                ),
              )
            : null,
          ...
          u.content
            ? n.createElement(
                ...
                n.createElement(
                  ...
                  u.content.slice(0, 2e3) +
                    (u.content.length > 2e3
                      ? `
...
function Bn({
  ...
  const r = h().React,
    { useState: s, useMemo: i, useCallback: f } = r,
    {
      Spin: c,
      Empty: p,
      Input: P,
    ...
    M = i(() => {
      ...
      return e.filter((ae) => {
        ...
        return (
          ae.name.toLowerCase().includes(o) ||
          ((U = ae.description) == null
            ? void 0
            : U.toLowerCase().includes(o)) ||
          ((Q = ae.tags) == null
            ? void 0
            : Q.some((J) => J.toLowerCase().includes(o)))
        );
      });
    }, [e, I]),
    u = f(
      (o) => {
        ...
        for (const U of t)
          if (U.skills.some((Q) => Q.name === o)) {
            ...
            ae.push(
              (Q == null ? void 0 : Q.name) || U.agent_name || U.agent_id,
            );
          }
        return ae;
      },
    ...
    d
      ? r.createElement(
          ...
          r.createElement(
            S,
            { column: 1, bordered: !0, size: "small" },
            r.createElement(S.Item, { label: "技能名称" }, d.name),
            r.createElement(S.Item, { label: "描述" }, d.description || "-"),
            d.version_text
              ? r.createElement(S.Item, { label: "版本" }, d.version_text)
              : null,
            r.createElement(S.Item, { label: "来源" }, d.source || "-"),
            r.createElement(
              S.Item,
              { label: "受保护" },
              d.protected ? "是（内置）" : "否",
            ...
            d.sync_status
              ? r.createElement(S.Item, { label: "同步状态" }, d.sync_status)
              : null,
            d.installed_from
              ? r.createElement(S.Item, { label: "安装来源" }, d.installed_from)
              : null,
          ),
          // Tags
          d.tags && d.tags.length > 0
            ? r.createElement(
                ...
                r.createElement(
                  ...
                  { style: { display: "flex", flexWrap: "wrap", gap: 4 } },
                  ...d.tags.map((o, ae) =>
                    r.createElement(A, { key: ae, color: "cyan" }, o),
                  ),
                ),
              )
            : null,
                  ...
                  renderItem: (o) =>
                    r.createElement(
                      ...
                      r.createElement(
                        ...
                        r.createElement("span", null, "🧑‍🔬"),
                        r.createElement(g, { style: { fontSize: 13 } }, o),
                      ),
                    ),
                })
              : r.createElement(
...
function jn() {
  const e = h().React,
    { useState: t, useEffect: a, useCallback: n, useMemo: l } = e,
    { Tabs: r, message: s } = h().antd,
    { ThunderboltOutlined: i, AppstoreOutlined: f } = h().antdIcons || {},
    p = h().useSelectedAgent,
    P = p ? p() : null,
    v = (P == null ? void 0 : P.id) || "default",
    [E, H] = t([]),
    [x, A] = t([]),
    [O, W] = t([]),
    [S, V] = t(!0),
    ...
    B = n(async () => {
      V(!0);
      try {
        const [I, q, T] = await Promise.all([it(), ot(), Lt()]);
        A(I), H(q), W(T);
      } catch (I) {
  ...
  try {
    ...
    if (!e) {
      ...
      if (a) {
        const n = [
          {
            id: $t(a.owner, a.repo, a.skillsPath),
            url: gt,
            label: a.label,
            owner: a.owner,
            repo: a.repo,
...
async function Un(e) {
  ...
  return await Promise.all(
    r.map(async (i) => {
      const f = `https://raw.githubusercontent.com/${e.owner}/${e.repo}/${
          e.ref
...
function Hn({ open: e, onClose: t, sources: a, onChange: n }) {
  const l = h().React,
    { useState: r } = l,
    {
      Modal: s,
    ...
    B = (g, z) => {
      const I = a.map((q) => (q.id === g ? { ...q, enabled: z } : q));
      tt(I), n(I);
    },
    N = (g) => {
  ...
  return l.createElement(
    s,
    {
      ...
      footer: l.createElement(f, { onClick: t }, "关闭"),
      width: 640,
    },
    l.createElement(
      "div",
...
function Xn() {
  ...
  const je = n(async (m) => {
    ...
    try {
      ...
      if ((Ae(ge), Pe.length > 0)) {
        for (const ye of Pe)
          console.warn(
            `[ugsci] GitHub source '${ye.label}' error: ${ye.message}`,
          );
        p.warning(`部分源加载失败: ${Pe.map((ye) => ye.label).join(", ")}`);
      }
    } catch (ge) {
  ...
  const G = n(async (m, Y, pe) => {
    Se(!0);
    try {
      const ge = await Jn(m, pe, 20, "zh", Y || void 0);
      pe === void 0 || Object.keys(pe).length === 0
        ? K(ge.results)
        : K((ve) => [...ve, ...ge.results]);
      const Pe = Object.values(ge.by_provider || {}).some((ve) => ve.has_more);
      D(Pe);
      const ye = {};
  ...
  const ce = () => {
    ...
    k = async (m) => {
      ...
      try {
        ie((ye) => ({ ...ye, [Y]: "starting" }));
        const ge = await yt(X, m.source_url, !0);
        ie((ye) => ({ ...ye, [Y]: "installing" }));
        const Pe = 60;
        for (let ye = 0; ye < Pe; ye++) {
          await new Promise((Oe) => setTimeout(Oe, 2e3));
          const ve = await ft(X, ge.task_id);
          if (
            ve.status === "completed" &&
            (pe = ve.result) != null &&
            pe.installed
          ) {
            p.success(`技能「${ve.result.name || m.name}」安装成功`),
              ie((Oe) => {
                const Me = { ...Oe };
    ...
    ze = l(() => {
      ...
      if ((Ie && (m = m.filter((Y) => Y.sourceLabel === Ie)), C.trim())) {
        ...
        m = m.filter((pe) => {
          var ge;
          return (
            pe.name.toLowerCase().includes(Y) ||
            ((ge = pe.description) == null
              ? void 0
              : ge.toLowerCase().includes(Y))
          );
        });
      }
      return m;
    }, [be, C, Ie]),
    ke = o.filter((m) => m.available),
    $e = l(() => {
      if (!Ie) return J;
      const m = ke.find((Y) => Y.label === Ie);
      return m ? J.filter((Y) => Y.source === m.key) : J;
    }, [J, Ie, ke]),
    ue = l(() => {
      const m = /* @__PURE__ */ new Set();
      return (
        de.filter((Y) => Y.enabled).forEach((Y) => m.add(Y.label)),
        ke.forEach((Y) => m.add(Y.label)),
        Array.from(m)
      );
    }, [de, ke]),
    Ze = e.createElement(
      ...
      we && !oe
        ? e.createElement(
            ...
            e.createElement(c, { onClick: ce, loading: oe }, "加载更多"),
          )
        : null,
      // Detail Drawer
      F
        ? e.createElement(
            ...
            e.createElement(
              S,
              { column: 1, bordered: !0, size: "small" },
              e.createElement(S.Item, { label: "来源" }, F.source),
              e.createElement(S.Item, { label: "描述" }, F.description || "-"),
              F.version
                ? e.createElement(S.Item, { label: "版本" }, F.version)
                : null,
              F.author
                ? e.createElement(S.Item, { label: "作者" }, F.author)
                : null,
              e.createElement(
                S.Item,
                { label: "来源链接" },
            ...
            F.stats
              ? e.createElement(
                  ...
                  e.createElement(
                    ...
                    ...Object.entries(F.stats).map(([m, Y]) =>
                      e.createElement(
                        "div",
    ...
    et = l(() => {
      ...
      return nt.filter(
        (Y) =>
          Y.name.toLowerCase().includes(m) ||
          Y.description.toLowerCase().includes(m) ||
          Y.category.toLowerCase().includes(m),
      );
    }, [le]),
    Xe = async (m) => {
      try {
        ...
        (pe.approval_level = m.approvalLevel),
          await te(`/agents/${encodeURIComponent(Y.id)}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
...
function Kn() {
  ...
  e.route.add(a, {
    ...
    (c = e.sidebar) != null && c.registerSimpleModeItems
