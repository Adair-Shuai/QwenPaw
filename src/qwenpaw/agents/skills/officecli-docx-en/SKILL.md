---
name: officecli-docx
description: "Use this skill any time a .docx file is involved. QwenPaw wraps common operations as office_* tools; this skill provides the deep DOCX schema knowledge (elements, properties, styles, TOC, tracked changes) that complements the tools."
metadata:
