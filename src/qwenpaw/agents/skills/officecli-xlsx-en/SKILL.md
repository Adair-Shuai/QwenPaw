---
name: officecli-xlsx
description: "Use this skill any time a .xlsx file is involved. QwenPaw wraps common operations as office_* tools; this skill provides the deep XLSX schema knowledge (cells, formulas, charts, pivot tables, conditional formatting) that complements the tools."
metadata:
