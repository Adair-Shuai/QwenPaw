...
(function(React2, reactDom) {
  ...
  function NodeCard({ id: id2, data, selected: selected2 }) {
    ...
    return React2.createElement(
      ...
      // Description
      d?.description ? React2.createElement("div", { style: { color: "var(--ant-color-text-tertiary, #8c8c8c)", marginTop: 4, fontSize: 11, maxWidth: 212, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, d.description) : null,
      // Node ID footer
      React2.createElement("div", { style: { marginTop: "auto", paddingTop: 4, color: "var(--ant-color-text-quaternary, #bfbfbf)", fontSize: 10, fontFamily: "monospace" } }, id2),
  ...
  function LabeledEdge(props) {
    ...
    return React2.createElement(
      ...
      React2.createElement("path", {
        id: id2,
        d: edgePath,
        stroke: selected2 ? "var(--ant-color-primary, #1677ff)" : data?.color || "var(--ant-color-text-quaternary, #bfbfbf)",
      ...
      React2.createElement(
        ...
        React2.createElement(
          ...
          editing ? React2.createElement("input", {
            ...
            style: {
              background: "var(--ant-color-bg-container, #fff)",
              border: selected2 ? "1px solid var(--ant-color-primary, #1677ff)" : "1px solid var(--ant-color-border, #d9d9d9)",
              borderRadius: 4,
              padding: "2px 6px",
              fontSize: 10,
              textAlign: "center",
  ...
  function FlowListPage({ onEdit, onRun }) {
    ...
    const deleteFlow = React2.useCallback(async (id2) => {
      Modal.confirm({
        ...
        onOk: async () => {
          try {
            await apiFetch(`/flowforge/flows/${encodeURIComponent(id2)}`, { method: "DELETE" });
            message?.success("已删除");
            refresh();
          } catch (e) {
    ...
    return React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement(Title, { level: 4, style: { margin: 0 } }, "工作流", React2.createElement("span", { style: { fontSize: 14, color: "var(--ant-color-text-tertiary, #8c8c8c)", marginLeft: 8 } }, "可视化 DAG 工作流引擎")),
        React2.createElement(
          Space,
          null,
  ...
  function FlowEditorPage({ flowId, onBack, onRun, runStatuses }) {
      ...
      (async () => {
        ...
        try {
          const [flow, types] = await Promise.all([
            apiFetch(`/flowforge/flows/${encodeURIComponent(flowId)}`),
            apiFetch("/flowforge/node-types")
          ]);
          if (cancelled) return;
          setDoc(flow);
    ...
    const onConnect = React2.useCallback((conn) => {
      setRfEdges((eds) => addEdge({ ...conn, type: "labeled", animated: true, data: { label: "" }, markerEnd: { type: MarkerType.ArrowClosed, color: "var(--ant-color-text-quaternary, #bfbfbf)" } }, eds));
    }, [setRfEdges]);
    ...
    return React2.createElement(
      ...
      React2.createElement(
        "div",
        { style: { padding: "8px 16px", borderBottom: "1px solid var(--ant-color-border-secondary, #f0f0f0)", display: "flex", alignItems: "center", gap: 8, flexShrink: 0 } },
      ...
      React2.createElement(
        ...
        React2.createElement(
          "div",
          { style: { width: 240, borderRight: "1px solid var(--ant-color-border-secondary, #f0f0f0)", display: "flex", flexDirection: "column", background: "var(--ant-color-fill-quaternary, #fafafa)" } },
          React2.createElement(
            "div",
            { style: { padding: "8px 12px", borderBottom: "1px solid var(--ant-color-border-secondary, #f0f0f0)" } },
            React2.createElement(Input, {
              placeholder: "搜索节点...",
            ...
            Object.entries(palette).map(([cat, items]) => React2.createElement(
              ...
              items.map((spec) => React2.createElement(
                "div",
                {
                  ...
                  onMouseLeave: (e) => {
                    e.currentTarget.style.borderColor = "var(--ant-color-border-secondary, #e8e8e8)";
                  },
        ...
        React2.createElement(
          ...
          React2.createElement(
            index,
            {
              ...
              isValidConnection,
              fitView: true,
              style: { background: "var(--ant-color-fill-quaternary, #f5f5f5)" },
              deleteKeyCode: null
            },
            React2.createElement(Background, { variant: BackgroundVariant.Dots, gap: 16, size: 1 }),
            React2.createElement(Controls, null),
            React2.createElement(MiniMap, { style: { background: "var(--ant-color-fill-quaternary, #fafafa)" }, nodeColor: (n) => nodeColor(n.data?.class_type || ""), nodeStrokeWidth: 2 }),
            ...
            React2.createElement(
              ...
              React2.createElement(
                ...
                React2.createElement(
                  Tooltip,
                  { title: "顶部对齐" },
                  React2.createElement(Button, { size: "small", type: "text", icon: VerticalAlignTopOutlined ? React2.createElement(VerticalAlignTopOutlined) : void 0, onClick: () => alignNodes("top") }, !VerticalAlignTopOutlined ? "⬆" : null)
                ),
                React2.createElement(
                  Tooltip,
                  { title: "底部对齐" },
                  React2.createElement(Button, { size: "small", type: "text", icon: VerticalAlignBottomOutlined ? React2.createElement(VerticalAlignBottomOutlined) : void 0, onClick: () => alignNodes("bottom") }, !VerticalAlignBottomOutlined ? "⬇" : null)
                ),
                React2.createElement("div", { style: { width: 1, background: "var(--ant-color-border-secondary, #e8e8e8)", margin: "0 2px" } }),
                React2.createElement(
                  Tooltip,
                  { title: "水平分布" },
  ...
  function NodeInspector({ node, nodeTypes: nodeTypes2, onUpdate }) {
    ...
    return React2.createElement(
      ...
      spec?.description ? React2.createElement(Paragraph, { type: "secondary", style: { fontSize: 12, background: "var(--ant-color-fill-tertiary, #f5f5f5)", padding: 8, borderRadius: 4 } }, spec.description) : null,
        ...
        React2.createElement(Tabs, {
          items: [
            ...
            },
            {
              key: "outputs",
              label: "输出",
              children: Object.keys(run.outputs || {}).length ? React2.createElement("pre", { style: { background: "var(--ant-color-fill-tertiary, #f5f5f5)", padding: 8, borderRadius: 4, fontSize: 11, overflow: "auto", maxHeight: 400 } }, JSON.stringify(run.outputs, null, 2)) : React2.createElement(Empty, { description: "无输出" })
            },
            {
              key: "errors",
              ...
              children: run.errors?.length ? run.errors.map((e, i) => React2.createElement(Paragraph, { key: i, type: "danger", style: { fontSize: 12, background: "var(--ant-color-error-bg, #fff2f0)", padding: 8, borderRadius: 4, marginBottom: 4 } }, e)) : React2.createElement(Empty, { description: "无错误" })
            },
            {
              key: "events",
              ...
              children: events.length === 0 ? React2.createElement(Empty, { description: "等待事件..." }) : React2.createElement(Timeline, {
                items: events.slice(-50).map((ev) => ({
                  ...
                  children: React2.createElement(
                    ...
                    ev.data ? React2.createElement("pre", { style: { fontSize: 10, margin: "4px 0 0 0", background: "var(--ant-color-fill-tertiary, #f5f5f5)", padding: 4, borderRadius: 2, overflow: "auto", maxHeight: 120 } }, JSON.stringify(ev.data, null, 2)) : null
                  )
                }))
              })
            }
