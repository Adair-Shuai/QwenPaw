...
export function MarketplacePage() {
  ...
  const [agentDetail, setAgentDetail] = useState<OssAgent | null>(null);
  ...
  const expertsMarketTab = React.createElement(
    ...
    ossAgentLoading && filteredOssAgents.length === 0
      ? React.createElement(
          "div",
          { style: { textAlign: "center", padding: 40 } },
          React.createElement(Spin, { size: "large" }, React.createElement("div", { style: { minHeight: 60, display: "flex", alignItems: "center", justifyContent: "center" } }, "正在加载人才市场...")),
        )
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      Text,
                      { type: "secondary", style: { fontSize: 11 } },
                      agent.tags.filter((t) => t !== "agent" && t !== "template" && t !== "workspace").slice(0, 3).join(" · ") || "人才模板",
                    ),
                    React.createElement(
                      Button,
                      {
  ...
  const tabItems = [
    ...
    },
    {
      ...
      label: React.createElement(
        ...
        { style: { display: "flex", alignItems: "center", gap: 6 } },
        UserAddOutlined
          ? React.createElement(UserAddOutlined, { style: { fontSize: 14 } })
          : null,
        "人才市场",
      ),
    ...
    agentDetail
      ? React.createElement(
                ...
                React.createElement(
                  ...
                  agentDetail.category
                    ? React.createElement(
                        Tag,
                        { color: "blue", style: { fontSize: 10 } },
                        _tagGroupLabel(agentDetail.category),
                      )
                    : null,
                  ...agentDetail.tags
                    .filter(
            ...
            footer: React.createElement(
              ...
              React.createElement(
                Button,
                {
                  ...
                  onClick: async () => {
                    await handleCreateOssAgent(agentDetail);
                    setAgentDetail(null);
                  },
                },
                "创建专家",
          ...
          React.createElement(
            ...
            React.createElement(
              Text,
              { strong: true, style: { display: "block", marginBottom: 6 } },
              "简介",
            ),
            React.createElement(
              Paragraph,
          ...
          agentDetail.instructions
            ...
            : null,
          // Drivers
          agentDetail.drivers && Object.keys(agentDetail.drivers).length > 0
            ? React.createElement(
                "div",
                null,
                React.createElement(
                ...
                React.createElement(
                  ...
                  ...Object.entries(agentDetail.drivers).map(
                    ([driver, tools]) =>
                      React.createElement(
                        Tag,
                        { key: driver, color: "cyan", style: { fontSize: 11 } },
                        `${driver}${tools && tools.length > 0 ? ` (${tools.join(", ")})` : ""}`,
                      ),
                  ),
                ),
              )
