...
from plugins.bundle.ugsci.software_detector import detect_software, _get_comsol_from_registry, _get_comsol_version_dirs
...
def test_comsol_detection():
    ...
    if comsol_found:
        ...
        print(f"      版本: {comsol_found.version or '未检测到'}")
        print(f"      路径: {comsol_found.executable_path or '未找到'}")
        print(f"      安装目录: {comsol_found.install_dir or '未找到'}")
